...
import com.example.app_bluetooth.SerialListener;
...
class SerialSocket extends BluetoothGattCallback {
    ...
    private static final UUID BLUETOOTH_E4_READER = UUID.fromString("e2048b39-d4f9-4a45-9f25-1856c10d5639");
    private static final UUID BLUETOOTH_E4_WRITER = UUID.fromString("914f8fb9-e8cd-411d-b7d1-14594de45425");
    private static final UUID BLUETOOTH_E4_SERVICE_ID = UUID.fromString("866d3b04-e674-40dc-9c05-b7f91bec6e83");
    ...
    void connect(SerialListener listener) throws IOException {
        System.out.println("Veio aqui 0");
...
//                onSerialConnectError(new IOException(context.getString(R.string.pairing_request)));
    ...
    public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
        System.out.println("Veio aqui 1");
    ...
    private void connectCharacteristics1(BluetoothGatt gatt) {
        ...
        for (BluetoothGattService gattService : gatt.getServices()) {
            ...
            if (gattService.getUuid().equals(BLUETOOTH_E4_SERVICE_ID))
                delegate = new E4Delegate();
            if(delegate != null) {
    ...
    private class E4Delegate extends DeviceDelegate {
        @Override
        boolean connectCharacteristics(BluetoothGattService gattService) {
            Log.d(TAG, "service E$");
            readCharacteristic = gattService.getCharacteristic(BLUETOOTH_E4_READER);
            writeCharacteristic = gattService.getCharacteristic(BLUETOOTH_E4_WRITER);
            return true;
        }
    }
